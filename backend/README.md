...
- Services: `AccountingService`, `OperationService`, `VoucherService`
...
Seeded dataset: 4 users, 5 services, 5 vendors, 8 clients, 12 operations, 10 vouchers, 2 safes, balanced journal.
...
| POST | `/api/operations/{id}/cancel` | Sales, accountant |
